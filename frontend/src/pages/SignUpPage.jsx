        ...
        <div className='w-full'>
            <form onSubmit={handleSignup}>
                <div className='space-y-4'>
                    ...
                    <p className='text-sm opacity-70'>Join Yaptime and start your language learning adventure</p>
                </div>
                <div className='space-y-3'>
                    <div className='form-control w-full'>
                        ...
                        <input type='text' placeholder='John Deo' className='input input-bordered w-full' value={signupData.fullName} onChange={(e)=> setSignupData({...signupData, fullName:e.target.value})} required />
                    </div>
                      <div className='form-control w-full'>
                        <label className='label'>
                            <span className='label-text'>Email</span>
                        </label>
                        <input type='email' placeholder='johndeo@example.com' className='input input-bordered w-full' value={signupData.email} onChange={(e)=> setSignupData({...signupData, email:e.target.value})} required />
                    </div>
                       <div className='form-control w-full'>
                        <label className='label'>
 ...
 * 
 * once you fill the form the handleSignup function gets called and preventDefault will prevent the 
